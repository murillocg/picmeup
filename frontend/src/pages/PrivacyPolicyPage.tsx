    ...
    <div className="max-w-3xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        ...
        <a
          ...
          download
          className="flex items-center gap-2 bg-brand-orange text-white px-4 py-2 rounded-lg hover:bg-brand-orange-dark text-sm font-medium"
        >
        ...
        >
          <div className="flex flex-col items-center justify-center py-16 text-gray-500 gap-4">
            ...
            <a
              ...
              className="bg-brand-orange text-white px-4 py-2 rounded-lg hover:bg-brand-orange-dark text-sm font-medium"
            >
              Open PDF
            </a>
          </div>
      ...
      <div className="sm:hidden bg-white rounded-xl border border-gray-200 shadow-sm p-8 flex flex-col items-center gap-4 text-center">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="w-full bg-brand-orange text-white px-4 py-3 rounded-lg hover:bg-brand-orange-dark text-sm font-medium text-center"
        >
          Open Privacy Policy
        </a>
        <a
